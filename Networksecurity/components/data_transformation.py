...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        It initializes a KNN IMputer object with the parameters specified in the trianing_pipeline.py file
        ...
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)## ** means key value
            logging.info(
